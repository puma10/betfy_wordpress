...
if(!empty($_POST['update'])){
	...
	if($_POST['active']=='1' AND empty($_POST['name'])){
		...
		echo '<div class="alert alert-danger">The Rank number is not numeric</div>';
	}else{
		if(!empty($_POST['name'])) { $name=$_POST['name']; }else { $name=''; }
		if(!empty($_POST['active'])) { $active=$_POST['active']; }
		if(!empty($_POST['rank'])) { $rank=$_POST['rank']; }
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="name">Rank number</label>  
  <div class="col-md-5">
  <input id="rank" name="rank" required type="text" placeholder="only number : 1,2,3,..." class="form-control input-md" <?php if(!empty($rank)){ echo "value='".$rank."'"; } ?>>
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="name">Name of the "Top"</label>  
  <div class="col-md-5">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="link">(affiliate) Link</label>  
  <div class="col-md-5">
...
<div class="panel panel-primary">
  ...
  <br><b>Description : </b>between 50 and 160 characters (spaces included), and no more than 24 words in length
						...
						<div class="form-group">
						  ...
						  <div class="col-md-5">
						  <input id="feature1" name="seo_title" type="text" placeholder="-" class="form-control input-md" <?php if(!empty($seo_title)){ echo "value='".$seo_title."'"; } ?>>    
						  </div>
						</div>
						<!-- Text input-->
						<div class="form-group">
						  ...
						  <div class="col-md-5">
						  <input id="feature2" name="seo_description" type="text" placeholder="-" class="form-control input-md" <?php if(!empty($seo_description)){ echo "value='".$seo_description."'"; } ?>>        
						  </div>
						</div>
...
<div class="panel panel-primary">
  ...
  <div class="panel-body">
    ...
    <!-- File Button --> 
	<div class="form-group">
	  <label class="col-md-4 control-label" for="filebutton"><?php if(!empty($banner1)){ echo '<a href="../banner/'.$banner1.'" target="_blank">(Actual banner)</a>'; } ?> Banner 1 </label>
	  <div class="col-md-4">
	...
	<!-- File Button --> 
	<div class="form-group">
	  <label class="col-md-4 control-label" for="filebutton"><?php if(!empty($banner2)){ echo '<a href="../banner/'.$banner2.'" target="_blank">(Actual banner)</a>'; } ?> Banner 2 </label>
	  <div class="col-md-4">
